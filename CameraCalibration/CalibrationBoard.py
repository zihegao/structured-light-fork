...
# Define parameters
squares_Nx = 5              # number of chessboard squares in X direction
squares_Ny = 7              # number of chessboard squares in Y direction
...
# Explicitly specify DPI and paper size
...
# Generate the image with the desired size (in pixels). If the printer uses the same DPI setting, the physical size will be correct.
